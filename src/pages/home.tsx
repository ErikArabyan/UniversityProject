		...
		<div className='min-h-screen pb-20'>
			...
			<div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-16'>
				...
				<div className='text-center max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28'>
					<h1 className='text-4xl md:text-6xl font-bold tracking-tight text-indigo-400 mb-8'>Վեբկայքի նշանակությունը</h1>
					<p className='text-lg md:text-xl text-muted-foreground leading-relaxed'>Կայքի նպատակն է օգնել օգտվողներին սովորել տվյալների ցուցադրման հիմունքները՝ օգտագործելով D3.js, Chart.js և Highcharts.js գրադարանները. Պլատֆորմը միավորում է տեսությունը, կոդերի օրինակները և ինտերակտիվ պրակտիկան, որպեսզի օգտագործողը կարողանա ոչ միայն կարդալ բացատրությունը, այլ անմիջապես տեսնել կոդի աշխատանքի արդյունքը:</p>
					<ul className='text-lg md:text-xl text-muted-foreground leading-relaxed'>
						<li>բացատրում է յուրաքանչյուր գրադարանի աշխատելու ձևը և առանձնահատկությունները․</li>
						<li>քայլ առ քայլ ցույց է տալիս և բացատրում, թե ինչի համար է կոդը։</li>
						<li>թույլ է տալիս գործարկել օրինակներ և անմիջապես ստուգել արդյունքը էջում․</li>
						<li>օգնում է նյութը համախմբել հաջորդական դասերի միջոցով:</li>
					</ul>
					<p className='text-lg md:text-xl text-muted-foreground leading-relaxed'>Сайт предназначен для студентов, начинающих разработчиков и всех, кто хочет научиться создавать понятные, наглядные и интерактивные графики для веб-приложений.</p>
				</div>
			</div>
		</div>
	);
