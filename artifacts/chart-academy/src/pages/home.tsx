...
import { ArrowRight, BookOpen, Code2, LineChart, Star } from "lucide-react";
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-foreground">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-indigo-400">Data Visualization</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
              Learn D3.js, Chart.js, and Highcharts right in your browser. 
              Write code, see results instantly, and build beautiful charts.
            </p>
          </motion.div>
        </div>
      </div>
              ...
              <motion.div key={lib.id} variants={item}>
                ...
                >
                  <div className="h-full bg-card rounded-2xl p-6 border border-border shadow-sm hover:shadow-lg hover:border-primary/50 transition-all duration-300 flex flex-col relative overflow-hidden">
                    ...
                    <div className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-primary/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity rounded-bl-full pointer-events-none -z-0`} />
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-muted-foreground text-sm mb-6 flex-grow">{lib.description}</p>
                      
                      <div className="mt-auto space-y-4">
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-muted-foreground flex items-center gap-1.5">
                            <Code2 className="w-4 h-4" />
                            {lib.lessons.length} Lessons
                          </span>
